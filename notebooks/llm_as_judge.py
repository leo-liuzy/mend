...
for fpath in tqdm(
    [
        "/u/zliu/datastor1/mend/synstory_exp_output/llama3.1-8B-eos-sft-template-format-curated-v1-lr2e-6-sample-10-max/4K_test_ood/base_n=350_prompt=no_w-gen_wo-icl_ice=True.xlsx",
    ]
):
