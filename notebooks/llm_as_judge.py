...
for fpath in tqdm(
    [
        "/data/users/zliu/mend/synstory_exp_output/qwen_noshare_max_30K_14_27/syn_story/mend_eval_loss=clm_input=seen_n=500_prompt=no_w-gen_wo-icl_4K_test_id-question.xlsx",
    ]
):
