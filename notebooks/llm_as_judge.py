...
for fpath in tqdm(
    [
        "/datastor1/zliu/mend/synstory_exp_out/4K_heavy_noshare_midupper3/syn_story/mend_eval_loss=clm_input=seen_n=100_prompt=no_w-gen_wo-icl_4K_test_ood-question.xlsx",
    ]
):
