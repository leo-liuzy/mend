...
for fpath in tqdm(
    [
        "/u/zliu/datastor1/mend/synstory_exp_output/3B_4K_heavy_noshare_midupper3/syn_story/mend_eval_loss=clm_input=seen_n=350_prompt=no_w-gen_wo-icl_4K_test_ood-entity-question.xlsx",
    ]
):
