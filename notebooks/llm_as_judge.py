...
for fpath in tqdm(
    [
        "/datastor1/zliu/mend/synstory_exp_output/4K_heavy_share_top3/syn_story/mend_eval_loss=clm_input=seen_n=500_prompt=no_w-gen_wo-icl_4K_test_id-question.xlsx",
    ]
):
