...
for fpath in tqdm(
    [
        "/data/users/zliu/mend/synstory_exp_output/llama3.1-8B-eos-sft-template-format-curated-v1-lr2e-6-sample-10/4K_test_id/base_n=500_prompt=no_w-gen_wo-icl_ice=True.xlsx",
    ]
):
