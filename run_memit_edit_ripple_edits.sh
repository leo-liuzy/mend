...
for config_name in llama3.2-1B-eos-sft-estimated-wiki  # llama3.2-1B-eos-sft-mid-upper # llama3.2-1B-eos-sft-top # llama3.2-1B-eos-sft-mid-upper
do
for mom2_dataset in "wikipedia" 
do
