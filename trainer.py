...
class EditTrainer(BaseTrainer):
    ...
    def _inline_validation_log(self, step, stats, start_time, steps):
        ...
        if self.config.task in ["fc", "qa", "zsre", "musique", "musique_dropout", "musique_dropout_better", "musique_combiner_q", "musique_injector", "musique_combiner_text", "musique_propagator_text", "bio_syn", "bio_syn_v2", "country_syn", "ripple_edits"]:
