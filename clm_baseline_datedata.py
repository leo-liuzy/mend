...
class CustomConfig:
    ...
    base_model_name: Optional[str] = "Llama-3.2-1B-common-date-eos-sft"
...
spec_dev_dataset = io.load_jsonlines(f"{vars.DATA_DIR}/debug_meta_train/common_date_data/valid.jsonl") # this will include both atomic efficacy question

instance = cpt_dev_dataset[custom_cfg.example_idx]

logging.info(f"Example: {instance}")

fpath = f"{individual_result_save_dir}/{custom_cfg.example_idx}_eval_results.xlsx"
