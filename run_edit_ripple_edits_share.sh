...
declare -A name2id=(
    ...
    [ripple_edits_all_heavy-share-mid-upper3_all-in-outer]=2025-05-14_17-49-28_6313098577
)
...
for exp_dir_name in ripple_edits_all_heavy-share-mid-upper3_all-in-outer
do
