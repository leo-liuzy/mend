...
declare -A name2id=(
    ...
    [4K_heavy_share_top3]=2025-05-15_09-47-33_9870165074
)
...
for date_data in 4K_test_ood-relation # 4K_test_ood 4K_test_ood-entity 4K_test_ood-relation 
do
exp_dir_name=4K_heavy_share_top3
