...
python -m run +alg=mend +experiment=bio_syn_v2 +model=llama3.2-1B-common-date-year-after-eos-sft-mid-upper val_steps=100 log_interval=10 val_interval=100 early_stop_patience=2000 +train_set_size=${train_set_size} heavy_outerloop=False mend.shared=False 
