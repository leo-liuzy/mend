...
model_name_or_path = "/data/users/zliu/mend/models/Llama-3.2-1B-eos-sft-template-format-curated-v1-lr2e-6-sample-10"
...
train_dataset = prepare_sft_text(
    args, io.load_jsonlines(f"{vars.DATA_DIR}/debug_meta_train/syn_data_neurips/model_prep/prop_questions.jsonl"), tokenizer
)
# train_dataset = prepare_sft_text(
