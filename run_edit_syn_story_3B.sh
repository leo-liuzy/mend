...
declare -A name2id=(
    [3B_4K_heavy_noshare_midupper3]=2025-05-11_00-22-02_5924024672
)
...
exp_dir_name=3B_4K_heavy_noshare_midupper3
archive=${name2id[$exp_dir_name]}
# date_data="4K_test_ood"

for date_data in  4K_test_ood-relation 4K_test_id # 4K_test_ood 4K_test_ood-entity #  4K_test_ood-relation 4K_test_id
do
