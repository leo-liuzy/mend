...
# for example_idx in {0..125} # {0..999}
# for example_idx in {126..250} # {0..999
# for example_idx in {251..375} # {0..999
for example_idx in {375..499} # {0..999
do
...
python clm_baseline_ripple_edits_active-reading.py \
    --seed=${seed} \
